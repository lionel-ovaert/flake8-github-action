...
function createCheck(check_name, title, annotations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (res.data.check_runs.length === 0) {
            yield octokit.checks.create(Object.assign(Object.assign({}, github.context.repo), { check_name, head_sha: github.context.sha, status: "completed", conclusion: "failure", output }));
        } else {
