...
function runFlake8() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec("/bin/bash -c \"git diff refs/heads/main -U0 | flake8 --diff --exit-zero --config .flake8 \"", [], options);
        return myOutput;
    });
}
...
function createCheck(check_name, title, annotations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (res.data.check_runs.length === 0) {
            yield octokit.checks.create(Object.assign(Object.assign({}, github.context.repo), { name: check_name, head_sha: github.context.sha, status: "completed", conclusion: "failure", output }));
        } else {
